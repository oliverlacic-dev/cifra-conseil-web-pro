...
import { ArrowRight, BarChart3, BriefcaseBusiness, Check, ClipboardCheck, FileCheck2, GraduationCap, Megaphone, Menu, MonitorCog, Settings, ShieldCheck, Sparkles, X } from 'lucide-react'
...
const services = [
  ...
  { icon: GraduationCap, title: 'Formation Odoo utilisateur', text: 'Des formations pratiques pour rendre vos équipes autonomes dans Odoo, avec des procédures adaptées à votre façon de travailler.' },
